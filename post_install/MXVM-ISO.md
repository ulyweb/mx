...
Here is the complete, updated XML file for your BlissOS VM. This version includes the specific routing to your Intel integrated graphics card (`renderD128`) to bypass the NVIDIA freeze.

Just copy this entire block, paste it over your current XML, and click **Apply** ⚙️:
...
<domain type="kvm" xmlns:qemu="http://libvirt.org/schemas/domain/qemu/1.0">
  ...
  <devices>
    ...
    <graphics type="egl-headless">
      <rendernode>/dev/dri/renderD128</rendernode>
    </graphics>
    <sound model="ac97">
      <audio id="1"/>
      <address type="pci" domain="0x0000" bus="0x00" slot="0x06" function="0x0"/>
...
Once you apply this, start the VM and select the **QEMU/KVM - Virgl - SW-FFMPEG** option again.

Did routing the 3D graphics through the Intel card successfully get you past that freeze and onto the Android desktop?
